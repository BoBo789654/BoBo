...
{
	public class BatSummoningStaffB : ModItem//蝙蝠召唤杖：血红法杖·改，略有区别
	{
		public override string Texture => Pictures.Summon + Name;
		public override void SetStaticDefaults()
		{
			ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<BatSummoningStaffC>();
		...
		public override void SetDefaults()
		{
			...
			Item.buffType = ModContent.BuffType<BatSummoningBuffB>();
			Item.shoot = ModContent.ProjectileType<BatB>();
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.SoulBottleMight, 10);//力量之魂
